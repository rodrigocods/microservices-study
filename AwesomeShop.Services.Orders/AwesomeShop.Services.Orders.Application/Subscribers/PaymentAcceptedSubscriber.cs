...
namespace AwesomeShop.Services.Orders.Application.Subscribers
{
    public class PaymentAcceptedSubscriber : BackgroundService
    {
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            // adiciona o codigo a ser executado quando consumir alguma mensagem da fila
            consumer.Received += async (sender, eventArgs) => {
                ...
                if (result)
                    _channel.BasicAck(eventArgs.DeliveryTag, false); // marca a mensagem como processada e remove da fila
            };
